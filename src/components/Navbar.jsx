  ...
  return (
    <nav className="bg-blue-700 text-white px-8 py-4 flex justify-between items-center shadow-md">
      ...
      <div className="flex gap-6 items-center">
        ...
        <Link to="/real-jobs" className="hover:text-yellow-300 transition font-medium">🔍 Live Jobs</Link>
        <Link to="/interview-prep" className="hover:text-yellow-300 transition font-medium">🎯 Interview</Link>
        {user ? (
          <>
            ...
            <button onClick={handleLogout} className="bg-white text-blue-700 px-4 py-2 rounded-lg font-medium hover:bg-yellow-300 hover:text-blue-900 transition">Logout</button>
          </>
        ) : (
          <>
            <Link to="/login" className="hover:text-yellow-300 transition font-medium">Login</Link>
            <Link to="/register" className="bg-yellow-400 text-blue-900 px-4 py-2 rounded-lg font-medium hover:bg-yellow-300 transition">Register</Link>
          </>
        )}
      </div>
    </nav>
